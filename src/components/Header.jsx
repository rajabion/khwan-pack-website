        ...
        <header className="fixed top-0 inset-x-0 z-50 transition-all duration-300">
            <div className="mx-auto px-4 sm:px-6 lg:px-8">
                <div className="glass mt-4 rounded-3xl px-6 py-3 flex items-center justify-between border border-white/40">
                    ...
                    {/* Logo */}
                    <Link to="/" className="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-900 tracking-tighter">
                        KhwanPack
                    </Link>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/quote-review" className="relative p-2 text-slate-700 hover:text-blue-700 transition-colors">
                            <ShoppingBag size={22} />
                            {cartCount > 0 && (
