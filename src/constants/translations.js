export const translations = {
  ar: {
    ...
    services: {
      ...
      s2_desc:
        'نستخدم أحدث تقنيات الطباعة اللي تطلع ألوانك زي ما هي بالشاشة.. وأحلى.',
  ...
  en: {
    ...
    about: {
      ...
      desc2:
        'We obsess over details: cup texture, color vividness, even lid quality. Because we know packaging is your "Silent Ambassador" to the customer.',
    },
    configurator: {
    ...
    services: {
      ...
      s2_desc:
        'We use the latest printing tech that outputs your colors exactly as seen on screen.. and better.',
